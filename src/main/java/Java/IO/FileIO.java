...
public class FileIO {
    ...
    public  static void main(String[] args){
        ...
        copyFile("uday.txt", "uday-bak.txt");
    ...
    private static void copyFile(String file1, String file2){
        ...
        try {
            ...
            copyFile(bi, bo, false);
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
    }

    // TODO what the heck is this boolean close
    private static void copyFile(InputStream is, OutputStream os, boolean close ){
        try{
        byte[] byteArr = new byte[16384] ; // why this size
        int i;
    ...
    private static void copyFile(Reader is, Writer os, boolean close)
            throws IOException {
    ...
    public static void copyRecursively(File fromDir, File toDir, boolean create) throws IOException {
        //TODO where did this Debug class come from
